      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-400 mt-4 text-base leading-relaxed">
            Real stories from real explorers. Join thousands who have made Wanderlust their trusted travel partner.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative bg-white rounded-3xl p-8 sm:p-10 shadow-xl border border-gray-100">
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <div className="ml-auto text-right">
                ...
                <p className="text-sm font-semibold text-emerald-600">{t.tour}</p>
              </div>
            </div>
                ...
                {testimonials.map((_, i) => (
                  <button
                    ...
                    className={`rounded-full transition-all duration-300 ${
                      i === active ? 'w-6 h-2 bg-emerald-500' : 'w-2 h-2 bg-gray-200 hover:bg-emerald-200'
                    }`}
                  />
                ))}
              </div>
          ...
          <div className="flex flex-col gap-4">
            {testimonials.filter((_, i) => i !== active).slice(0, 3).map((rev) => (
              <button
                key={rev.id}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 line-clamp-2">{rev.review}</p>
                </div>
              </button>
            ))}
            ...
            <div className="bg-linear-to-r from-emerald-600 to-teal-600 rounded-2xl p-5 flex items-center gap-4 mt-2">
              ...
              <div>
                <p className="text-white font-bold text-sm">Trusted by 12,000+ travelers</p>
                <p className="text-emerald-100 text-xs mt-0.5">98% would recommend Wanderlust to a friend</p>
              </div>
            </div>
          </div>
        </div>
